...
public class ChronicleRaftLog implements RaftLog {
	...
	public static class Builder {
		...
		/**
		 * Creates a new hash container from this builder, storing it's data in
		 * off-heap memory, not mapped to any file. On ChronicleHash.close()
		 * called on the returned container, or after the container object is
		 * collected during GC, or on JVM shutdown the off-heap memory used by
		 * the returned container is freed.
		 * 
